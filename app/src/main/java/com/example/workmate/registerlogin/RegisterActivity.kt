    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String) {
        ...
        ref.setValue(user)
            .addOnSuccessListener {
                ...
                //launch new activity(LatestMessages) after successful registration
                val intent = Intent(this, LatestMessagesActivity::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TASK.or(Intent.FLAG_ACTIVITY_NEW_TASK)    //to clear all the previous activity
                startActivity(intent)
